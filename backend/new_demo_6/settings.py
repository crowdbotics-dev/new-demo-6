"""
Django settings for new_demo_6 project.
...
WSGI_APPLICATION = 'new_demo_6.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "new_demo_6 API",
    "DESCRIPTION": "API documentation for new_demo_6 App",
    "VERSION": "v1",
}
